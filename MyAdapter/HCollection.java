 ...
 * if this collection does not support the operation. If this is the case, these methods may, but are not required to, throw an UnsupportedOperationException if the invocation would have no effect on the collection. 
...
public interface HCollection 
{
     ...
     * @throws ClassCastException class of the specified element prevents it from being addede to this collection
     * @throws NullPointerException if the specified element is null and this collection does not support null elements
     * @throws IllegalArgumentException some aspect of the specified element prevents it from being added to this collection
     */
     ...
     * @return true if this collection changed as a result of the call
     * @see {@link #add(Object)}
     * @throws UnsupportedOperationException if this collection does not support th addAll method
